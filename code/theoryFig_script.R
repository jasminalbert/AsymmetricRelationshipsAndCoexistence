...
text(x=lblc["C","x"]-.05, y=lblc["C","y"], labels=c(expression(varphi^-1*('F'['C'['i\\i']]("C"["i\\i"])) )), srt=90, cex=2)
...
text(x=lblc["C","x"]+.06, y=lblc["C","y"], labels=c(expression('c'['i\\i'])), srt=90, cex=2)
#TeX('$e_i$')
#TeX('($c_{i\\setminus i}$)')
...
text(x=lblc["E","x"], y=lblc["E","y"], labels=c(expression('E'['i']^'#')), cex=2)
text(x=lblc["C","x"], y=lblc["C","y"], labels=c(expression('C'['i\\i']^'#')), srt=90, cex=2)
text(x=lblc["lab","x"], y=lblc["lab","y"],labels=paste0("(",letters[5],")"), cex=2)
}
