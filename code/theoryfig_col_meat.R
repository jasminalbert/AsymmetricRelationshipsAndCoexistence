...
#text(x=lblc["C","x"], y=lblc["C","y"], labels=TeX('($C_{i \\ i}$)'), srt=90, cex=2)
...
text(x=lblc["E","x"], y=lblc["E","y"], labels=TeX('$\\varphi^{-1}(F_{E_i}(E_i))$'), cex=2)
#text(x=lblc["C","x"], y=lblc["C","y"], labels=c(expression(phi^-1*'o'*'F'['C'['i/i']]("C"["i/i"]))), srt=90, cex=2)
text(x=lblc["C","x"], y=lblc["C","y"], labels=TeX('($\\varphi^{-1} \\circ F_{C_{i\\setminus i}}(C_{i\\setminus i})$)'), srt=90, cex=2)
...
text(x=lblc["E","x"], y=lblc["E","y"], labels=TeX('($E_i^{||} = F_{E_i}^{-1}\\circ \\varphi(e_i)$)'), cex=2)
text(x=lblc["C","x"], y=lblc["C","y"], labels=TeX('($C_{i\\setminus i}^{||} = F_{C_{i\\setminus i}}^{-1}\\circ \\varphi(c_{i\\setminus i})$)'), srt=90, cex=2)
