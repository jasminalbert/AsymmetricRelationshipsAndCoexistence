...
sampsA <- theoryfigpanel(dbmarg, pbmarg, qbmarg, ccop, x, y, gnrt_var=TRUE,col=T,log_points=T)
...
sampsB <- theoryfigpanel(dnmarg, pnmarg, qnmarg, ccop, x, y, samps=sampsA, oldp=pbmarg,xpd=NA,col=T, log_points=FALSE)
...
sampsC <- theoryfigpanel(dnmarg, pnmarg, qnmarg, ncop, x, y, gnrt_var=TRUE, xpd=NA,col=T, log_points=FALSE)
...
sampsD<-theoryfigpanel(dbmarg, pbmarg, qbmarg, ncop, x, y,samps=sampsC, oldp=pnmarg,col=T,log_points=T)
