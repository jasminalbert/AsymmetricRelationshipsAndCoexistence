...
estimates and functions coincide on (c), except for right-most point for species 2. For that species,
data were not available for $Q$ at $24^\circ$ from the original study of \cite{Descamps_2005}; \cite{Ellner_2016, Ellner_2019}
assumed constancy of $Q_2$ for $t$ between $18^\circ$ and $24^\circ$.\label{fig:VKQ}}
\end{figure}
