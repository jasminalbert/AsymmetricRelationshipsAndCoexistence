...
$$C_i(t)=( B_1(t)N_1(t)+B_2(t)N_2(t) )/(\delta N)$$ (again for both versions of the model), which
...
%***DAN: Might need this text below, in the section on the log-normal fecundities lottery model, but not here
