...
\section{Empirical application: decomposing storage effect in data}\label{sect:Empircal_app}

To decompose the storage effect and quantify contributions of ATA in empirical applications...
many correlation options 
