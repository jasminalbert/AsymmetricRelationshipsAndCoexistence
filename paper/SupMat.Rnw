...
In fig \ref{MT-fig:fig4} we plot IGR , $\Delta_i^{[E \nat C]}$, and IGR $-\Delta_i^{[E \nat C]}$ (see equation \ref{eq:decomp_overall_delta}) and the text below it.  
...
&= 0. %\label{eq:decomp:j:EnatC}
\end{align}
Then $q_{ij}$ does not matter for IGR or $\Delta_i^{[E \nat C]}$ because the second term in $\olr_{i \bs i}-q_{ij}\olr_{j \bs i}$ and $\Delta_i^{[E\nat C]}=\olep_i^{[E \nat C]}-q_{ij} \olep_j^{[E \nat C]}$ are zero so 
\begin{equation}
...
\Delta_i^{[E\nat C]}=\olep_i^{[E \nat C]}-q_{ij} \olep_j^{[E \nat C]}=\olep_i^{[E \nat C]}
\end{equation}
Similarly for IGR $-\Delta_i^{[E \nat C]}$, 
\begin{equation}
(\olr_{i \bs i}-q_{ij}\olr_{j \bs i})-\olep_i^{[E \nat C]}-q_{ij} \olep_j^{[E \nat C]} = \olr_{i \bs i}-\olep_i^{[E \nat C]}.
\end{equation}
Thus $q_{ij}$ does not matter for anything computed for Figure \ref{MT-fig:fig4}. 
