...
\end{figure}
%***DAN: Jasmin, in the caption of Fig. 3 in the main text there is a statment about standard
%error. We need another such statement here, but for the standard errors that applied here.
