...
\section{Theory for the lottery model}
...
Our investigation follows that of \cite{Ellner_2016, Ellner_2019} and 
...
{Species maximum growth rate (a), half saturation constant (b), and silica uptake (c) responses to changes in temperature. Species 1 is \emph{F. crotonensis}, shown in blue, and species 2 is \emph{C. pseudostelligera}, shown in red. Open circles and dashed lines indicate estimated data and interpolations from \cite{Descamps_2005} and closed circles and solid lines indicate values and function used in our analysis as defined in \cite{Ellner_2016, Ellner_2019}. \label{fig:VKQ}}
\end{figure}
