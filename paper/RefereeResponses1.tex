...
%DAN: Waiting on Jasmin to add the new panel. In other replies, you can refer to this reply to justify when you
%decide to add explanations to the SI instead of to the main text, and when you have to respond to requests
%to minimize the quant. Also fill in the correct value of CX above.
...
%Dan: to do this, not done yet.
%<Address the issue of whether and to what extent the process of removing ATAs is unique – probably just with a one-sentence callout in the main text, and some material in the SM (possibly a new section)>
...
%Jasmin to make the ammended figure, Dan to move it and the associatde text bck to main text
%The other main thing Jasmin should do is finalize the repo - checkpoint issues.
