...
\subsection{SI section X1 corresponding to the thoughts above, call it Temporal niche differentiation is necessary for ATA effects}\label{SIsect:temporal_niche_diff}
...
examples for ATA effects}\label{SIsect:intuition_examples}
