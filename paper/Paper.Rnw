...
\noindent \textbf{Number of references:} 39; \textbf{Number of figures:} 4; \textbf{Number of tables:} 1; \textbf{Number of text boxes:} 0\\
...
Additional discussion points are in SI sections \ref{SI-sect:vital_rates}-\ref{SI-sect:threeway}.
...
Jon Walter, Jude Kastens, Vadim Karatayev, Emily Arsenault, Jordan Rodriguez, Lauren Hallett, and 
...
%something.
%***JASMIN: Done. Added ticks to other panels and make x label bold
\begin{figure}
...
%***JASMIN: Fixed code. SE is small now. 
...
\begin{figure}
\includegraphics[width=\textwidth]{fig5_new.pdf}
