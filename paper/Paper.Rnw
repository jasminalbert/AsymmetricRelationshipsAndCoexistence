...
An additional driving reason to quantify the significance of ATAs for species coexistence is the potential for climate change to alter ATAs of environmental variables required in coexistence, as follows. 
