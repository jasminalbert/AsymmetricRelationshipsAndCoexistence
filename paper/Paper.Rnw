...
%G3 ***DAN: Dan, this will have to be edited after Jasmin gets done editing the corresponding figures
Fulfilling goal G3 of the Introduction (to provide an empirical example of species coexistence 
