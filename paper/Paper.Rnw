...
The rampage of extreme events such as heat-waves, floods, hurricanes, fires, etc. are a product of climate change and have implications for coexistence and competition. Changes in means can be attributed to extreme events; however changes in means are more-so a result of gradual increases or decreases over time in an environmental variable. 
