...
To further demonstrate the plausibility of ATAs altering coexistence between species, we carried out simulations using a simple two-species model, the lottery model. 
