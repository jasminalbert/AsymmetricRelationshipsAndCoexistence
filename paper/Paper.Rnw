...
An additional driving reason to quantify the significance of ATAs for species coexistence is the potential for climate change to alter ATAs of environmental variables implicated in coexistence, as follows. 
Among the various implications of climate change, the most potentially influential to ATAs in the environment is the increase in intensity, duration, extent, and frequency of extreme climatic events \citep{Jentsch_2007, Meehl_2004, Ummenhofer_2017}, i.e., heat-waves, floods, hurricanes, fires, etc. 
Temporally extensive extreme events can have important ecological impacts for
competing populations where species growth and the maintenance of biodiversity is dependent on phenologically separated environmental signals. A temporally extensive event can equalize the phenologically separated environmental signals, making them more correlated. For example, consider two precipitations signals, one in early spring and one in late summer, that are usually different. If a long flood occurs, it's likely that both signals will be close to equal in that year. If extreme floods occur in more years than not, then the two signals will become more correlated in higher precipitation values, a right-tailed ATA (figure \ref{fig:noise}C). Similarly, if extreme droughts occur in more years than not, then the signals will be more correlated in the lower values, a left-tailed ATA (figure \ref{fig:noise}A). The same can be said about spatially separated signals and more spatially extensive extreme events. ATA of environmental signals can then introduce or change ATAs in the fitness or traits of species that depend on the signals and potentially affect their coexistence.
%***DAN:
%1) Topic sentence: 
...
The community follows the criteria required for temporal storage effects to operate. Different species dominate and have high germination rates depending on rainfall timing. For example, Baileya multiradiata dominates if sufficient rainfall is reached in the early germination season. Eriogonum abertianum dominates if sufficient rainfall is reached in the late germination season. Competition is influenced by resource consumption of seed-producing adult plants. Dormant seeds are unaffected by competition and can persist in the community in an unfavorable environment. When rain fall dynamics temporally fluctuate from year to year, relative abundance and dominance of the desert annual community also fluctuate year to year. The result is a relationship between the desert annuals' environmental responses (germination) that is symmetrically associated... 

To make the above ideas more concrete, we review a relevant example from the literature that may be
influenced as previously described. 
We introduce a hypothetical example of the commonly studied two species grass-forb plant community \citep{Chesson_2012, Hallett_2019}.
The community follows the criteria required for temporal storage effects to operate. The forb dominates and has high fecundity when a sufficient threshold of rain is reached in the early season. The grass dominates and has high fecundity when there is sufficient rain in the late season. Competition is influenced by resource consumption of growing juvenile plants. Dormant seeds are unaffected by competition and can persist in the community in an unfavorable environment. When rain fall dynamics temporally fluctuate from year to year, relative abundance and dominance of the grass-forb community also fluctuate year to year. The result is a relationship between the grass's and forb's environmental responses (fecundity) that is symmetrically associated, and the species persist in coexistence... 

However, if environmental responses become asymmetrically associated by, say, extreme rainfall events, coexistence can be altered. If the community is disturbed by frequent and long floods with some years of normalcy, the grass-forb/desert annual 
environmental response relationship may become more correlated in the higher values, a right-tailed ATA (figure \ref{fig:noise}C). Conversely, if the community is disturbed by frequent and long drought with some years of normalcy, the grass-forb/desert annual environmental response relationship may become more correlated in the lower values, a left-tailed ATA (figure \ref{fig:noise}A). 
The subsequent potential changes in competitive ability and coexistence is not just attributed to the extreme event alone, but from the resulting extreme relationship between species (ATA). 
%Again, we see the possible consequences of ATA in Figure \ref{fig:pedagog}, i.e., less or no coexistence. 
...
Decreased mean growth season precipitation, for instance, can decrease the competitive ability of dominant forest tree species \citep{Clark_2011}, and coexistence is predicted to collapse between Mediterranean tree species in accordance to forecasted mean rainfall level decrease \cite{diPaola_2012}. 
...
%...and variance...
Although, the body of literature on the impact of increased environmental variability has expanded, event-based studies accounted for only one-fifth of experimental climate change research as of 2006 \citep{Jentch_2007}, the most commonly manipulated extremes being temperature and rainfall. Extreme drought and heat waves have shown impact competitive output and community composition of grassland plants\citep{White_2000, White_2001, Hoover_2014}. However, complete exclusion of dominant species due to extreme events is uncommon \citep{Lloret_2012}. \cite{Fay_2003} experimentally manipulated rainfall for more frequent and intense precipitation while keeping constant the total volume of rain over Kansas tallgrass prairie and found that while some species had reduced fitness, overall community structure remained the same. In regard to invasive species, increased climate and resource variability allowed for greater success of invasive plants in terms of density and competitive equilibrium \citep{Parepa_2013}. 
%...and extreme events (though this blends together with changes in variance)
Although, increased variability of environmental fluctuations is a newer consideration for studying environmental changes, environmental variability has been analytically shown to be important for classical coexistence \citep{Chesson_1981, Warner_1985}. Moreover, increased variability has been found to promote coexistence in plants communities \citep{Adler_2006,  Angert_2009}, but disrupt coexistence in birds \citep{Stenseth_2002, Stenseth_2015}. This present study has applications to extreme events and climate change as we consider relationships in their extremes, potentially caused by extreme events, and their implications for competition and coexistence.
