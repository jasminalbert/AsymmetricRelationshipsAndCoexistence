...
competing populations where species growth and the maintenance of biodiversity is dependent on
phenologically separated environmental signals, for instance, equalizing the signals, making them more correlated. 
Consider two precipitations signals, one in early spring and one in late summer, that are usually different. 
If a long flood occurs, it's likely that both signals will be close to equal in that year. 
If extreme floods occur in more years than not, then the two signals will become more correlated in higher precipitation values, a right-tailed ATA (figure \ref{fig:noise}C). 
Similarly, if extreme droughts occur in more years than not, then the signals will be more correlated in the lower values, a left-tailed ATA (figure \ref{fig:noise}A). 
The same can be said about spatially separated signals and more spatially extensive extreme events. 
ATA of environmental signals can then introduce or change ATAs in the fitness or traits of species that depend on the signals and potentially affect their coexistence.
%***DAN:
%1) Topic sentence: 
...
The community follows the criteria required for temporal storage effects to operate. 
Different species dominate and have high germination rates depending on rainfall timing. 
...
However, impacts on competition and coexistence of climate change have been more commonly researched via studying changes in the mean of environmental variables. 
...
Alternatively, dominant species exclusion may be beneficial as rare species can increase in diversity \citep{Mariotte_2013}, while an increase in dominant species fitness can reduce community diversity, typical of invasive species \citep{Vitousek_1997}. 
As a product of changing means, range shifts can favor plant coexistence by introducing new herbivores \cite{Descombes_2020} or disfavor coexistence through increased competition \cite{Usinowicz_2021}.  
%...and variance...
Although, the body of literature on the impact of increased environmental variability has expanded, event-based studies accounted for only one-fifth of experimental climate change research as of 2006 \citep{Jentsch_2007}, the most commonly manipulated extremes being temperature and rainfall. Extreme drought and heat waves have shown to impact competitive output, rearranging species composition and dominance of grass-forb communities \citep{White_2000, White_2001, Hoover_2014}; although, complete exclusion of dominant species is uncommon \citep{Lloret_2012}. \cite{Fay_2003} experimentally manipulated rainfall for more frequent and intense precipitation while keeping constant the total volume of rain over Kansas tallgrass prairie and found that while some species had reduced fitness, overall community structure remained the same. For invasive species, increased climate and resource variability allowed for greater success of invasibility in terms of density and competitive equilibrium \citep{Parepa_2013}. 
%...and extreme events (though this blends together with changes in variance)
Although, increased variability of environmental fluctuations is a newer consideration for studying environmental changes, environmental variability has been analytically shown to be important for classical coexistence, i.e. MCT \citep{Chesson_1981, Warner_1985}. Moreover, by using MCT, increased variability has been shown to promote coexistence in plants communities, via the aforementioned storage effect \citep{Adler_2006,  Angert_2009}. This present study has applications to extreme events and climate change as we consider relationships in their extremes, potentially caused by extreme events, and their implications for competition and coexistence. 
Though previous literature considers impacts of extreme events, change in means, and increased variability on species coexistence and competition and community dynamics in general, they do not directly consider ATA between species response caused by environmental changes -- extreme relationships caused by extreme events (but see \cite{Ghosh_2021} for impact of ATA on community aggregate properties).
...
%Move upl the lottery model para from Theory to here, suture up the rift that this will produce in theory
...
Our study presents a new mechanism of coexistence and biodiversity maintenance which may be influenced by climate change, 
and a means for understanding its importance for real systems. Need better ending sentence.
