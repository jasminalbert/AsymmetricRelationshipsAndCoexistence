...
%Though not directly related to our questions at hand, and for illustrative purposes,
Fig. \ref{fig:pedagog1}d,e show contrasting examples of ATAs in nature using 
plankton population density time series; many other examples of ATAs in nature have also been explored 
...
Storage effects refer to ... 
%effects of [temporal] niche partitioning which allow species to "store" benefits from favorable conditions to persists in unfavorable conditions
 and are reviewed conceptually below and defined formally in Theory. 
...
for coexistence. 
%For example, the robustness of our choice in specifying a bivariate normal partial sharp distribution,
%though a natural and canonical one, to other more esoteric specifications. 
