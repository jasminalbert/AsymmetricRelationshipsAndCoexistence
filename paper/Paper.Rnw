...
load(file="../results_numeric/fig2data.RData")
load(file="../results_numeric/M.rda")
load(file="../results_numeric/rho.rda")
se3 <- readRDS(file="../results_numeric/fig3.2maxse.RDS")
se4 <- readRDS(file="../results_numeric/fig4.2maxse.RDS")
@
...
\begin{figure}
\includegraphics[width=.5\textwidth]{../results_figs/fig1_vertical.pdf}
\caption{
...
\begin{figure}
\includegraphics[width=\textwidth]{../results_figs/fig3p2.pdf}
...
\begin{figure}
\includegraphics[width=\textwidth]{../results_figs/fig4p2.pdf}
