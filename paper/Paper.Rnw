...
to a competitive diatom model show that the contribution of ATAs to coexistence 
is non-negligible and meaningfully contributes to the coexistence of species. 
...
\underline{Paragraph summarizing results of G1 and how it compares and builds on prior theory.} 
...
\underline{paragraph summarizing results of G2 and how it compares and builds on prior theory}
Furthermore, we have shown not only that is it possible to decompose storage effect into the effect of correlation \emph{per se} and the effect of ATAs, but this new term that holds the contribution of not only the correlation but the structure of the correlation is a non-negligible term, in a simple lottery model. 

Seemingly consistent with fluctuation dependent mechanisms, 
as $\sigma$, the variation in the environment, increased, 
so did the the magnitudes of $\Delta_i^{[EC]}$ and $\Delta_i^{[E \nat C]}$.
...
\underline{paragraph summarizing results of G3 and how it compares and builds on prior theory}
Not only is the contribution of ATA non-neglible but in some cases the presence of absence of ATA can mediate the result of competition between species, i.e., coexistence or extirpation. 
...
%maybe the above sentence should go in caveats/assumptions paragraph 
ATA specialist? Does this go in this paragraph
...
\underline{paragraph summarizing results of G4 and how it compares and builds on prior theory}
...
\underline{how results apply to or inform patterns or management questions in real life}
ATA specialists?
climate change and ATA

\underline{caveats/assumptions that could change result}
