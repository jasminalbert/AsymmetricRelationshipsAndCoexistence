...
%Currently 148 of an allowed 150 words for Ecology Letters
\begin{abstract}
\noindent Species coexistence attracts wide 
interest in ecology. Modern coexistence
theory (MCT) identifies mechanisms of coexistence,
...
the possibility that environmental and competitive influences may be more related to each other
...
We extend the MCT to account for ATAs. Storage
effects are decomposed to show the influence of ATAs. Simulations of a simple model
...
the other and drive it to extinction \citep{Hardin_1960}.
...
Coexistence occurs through stabilizing factors and niche 
...
tropical trees \citep{Usinowicz_2012}, plankton \citep{Caceres_1997, Narawani_2013, Descamps_2005}, and corals \citep{Alvarez-Noriega_2020}. 
...
our recent work has shown that, in fact, ATAs are extremely common in ecology \citep{Ghosh_2020_AER}, and can influence 
