...
%***DAN: Dan got to here 2022 01 10, continue from here later.
...
$\theta(t)=\theta_0 (t) +  a\sin(2\pi t/P)$, defined by parameters $\theta_0 = 18, a = 6, P = 60$d. 
...
Like for G2, we first plotted the terms of equation \ref{eq:full_decomp} for the chemostat 
...
To further explore the parameter space, we generated two dimensional surface plots which reveal 
the subsets of parameter space where coexistence is possible with ranging degrees of ATA 
