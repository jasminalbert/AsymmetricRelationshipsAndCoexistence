...
The consequence of climate change that has the most potential to influence ATAs in the environment the increase in intensity, duration, extent, and frequency of extreme climatic events \citep{Meehl_2004, Ummenhofer_2017}, i.e., heat-waves, floods, hurricanes, fires, etc. 
...
Environmental fluctuations are directly impacted by climate change through changes in means and increased variance, both of which can be attributed to extreme events \citep{Hansen_2012}.
Currently, effects on competition and coexistence due to climate change are more widely researched through studying changes in the mean of environmental variables. 
Increased variance is less studied. 
% thus less likely to be a result of extreme events. 
%influenced by extreme climatic events as they increase in frequency, intensity, duration, and extent \citep{Meehl_2004, Ummenhofer_2017}. 
%Thus, the rampage of extreme events such as heat-waves, floods, hurricanes, fires, etc. implications for coexistence and competition. 
%Jasmin tried to split this para up into effects on coexistence of changes in mean, starting here... 
Changes in means can be attributed to extreme events; however changes in means are more-so a result of gradual shifts over time, whereas increased variance is more likely a product of extreme events as they push environmental variables to their extremes.

For example, decreased mean growth season precipitation can decrease the competitive ability of dominant forest tree species \citep{Clark_2011}. This may be detrimental if the dominant species is crucial to the ecosystem or it may not be as rare species can increase in diversity while dominant species become excluded \citep{Mariotte_2013}. Conversely, changes in environmental means can increase fitness of a dominant species and in turn reduce community diversity, typical of invasive species \citep{Vitousek_1997}. \cite{Descombes_2020}, through experimental manipulation, found that range shifts, as a product of climate change, favored coexistence between alpine plants while \cite{Usinowicz_2021} predict increases in competitive pressures as the climate change induced range shifts lead populations to interact with new conspecifics. Similarly, \cite{diPaola_2012} predict the collapse of coexistence between Mediterranean tree species as mean rainfall levels are forecasted to decrease.    
%...and variance...
In contrast, increased environmental variance has been less commonly studied; however, more research on the effect of increased variance has been urged and received recent focus through the study of extreme climatic events \citep{Jentsch_2007, Smith_2011}. Extreme drought and heat waves impact competitive output and community composition of grassland plants\citep{White_2000, White_2001, Hoover_2014}. However, complete exclusion of dominant species due to extreme events is uncommon \citep{Lloret_2012}. Moreover, in regard to invasive species, increased climate and resource variability allowed for greater success of invasive plants in terms of density and competitive equilibrium \citep{Parepa_2013}. 
