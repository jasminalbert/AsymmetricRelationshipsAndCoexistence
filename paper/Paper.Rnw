...
network of habitat patches and the GWR of a weaker competitor is only positive 
...
and can therefore be regarded as an ``ATA specialist'' in the landscape. EC-associations
can often boil down to associations between two environmental variables, as was the case
for the lottery model we considered. Mechanisms of coexitence should correspond to
