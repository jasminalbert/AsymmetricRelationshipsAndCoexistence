...
for a species and the strength of competition (C) experienced by that species (called EC covariance), that is stronger when the species is common than when it is rare. 
...
Importantly, the storage effect can be quantified by measuring to what extent EC covariance contributes to differences between 
...
for both rare and common species [see (\ref{eq:storage_effects_gen})]. 
...
to the rare/common species growth rate difference. 
