...
plankStats <- readRDS(file=paste0(res_loc, "plankStats.RDS"))
...
plankton population density time series; and many other examples have also been previously explored 
\citep{Ghosh_2020_AER,Ghosh_2020_ecolevol,Ghosh_2021}. To our knowledge, the implications of ATAs for 
competition and coexistence have not yet been investigated. Doing so is the overarching goal of this study. 
...
in the North Sea considered by \citep{Ghosh_2020_ecolevol}. ATAs differed by location: 
(d) has a partial Spearman correlation of  \Sexpr{round(plankStats$d,3)}, indicating left-tail association
 and (e) has a partial Spearman correlation of  \Sexpr{round(plankStats$e,3)}, indicating right-tail association \cite{Ghosh_2020_AER}.
