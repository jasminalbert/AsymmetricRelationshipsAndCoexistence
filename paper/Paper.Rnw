...
\begin{figure}
\includegraphics[width=\textwidth]{"../results_figs/fig1_vertical.pdf"}
\caption{
...
\begin{figure}
\includegraphics[width=\textwidth]{"../results_figs/fig3.2.pdf"}
...
\begin{figure}
\includegraphics[width=\textwidth]{"../results_figs/fig4.2.pdf"}
