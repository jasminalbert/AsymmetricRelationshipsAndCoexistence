...
\affil[b]{Environmental Studies Program and Department of Biology, Universit of Oregon}
...
\noindent \textbf{Words in Abstract:} 150; \textbf{Words in main text:} 5518; \textbf{Words in text boxes:} 0\\
...
in the North Sea considered by \citep{Ghosh_2020_ecolevol}. ATAs differed by location, with (d) showing 
left-tail association and (e) showing right-tail association.
...
\end{figure}
%***DAN: Jasmin, please note that the standard error number that currently comes up is about 0.27, which
%is actually really big compared to the plotted values. Is this a temporary value based on a limited set 
%of sims, and you're planing to do a larger number? If this is the actual value based on the final number 
%of sims that you plan to do, then we may have to figure out a way to plot standard errors. Let's discuss
%The same problem occurs for the accompany SI figure.
