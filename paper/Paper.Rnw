...
Typesetting procedures used by publishers of ecological journals render mathematics sub-optimally,
so we have appended a latex version of this main text to the end of the 
Supporting Information (SI). Readers interested in the mathematical content
of the study should read that version.
...
storage potential is high, ATA effects will be high, and vice versa.
...
which are not completely offset by declines at other times. 
...
Details and examples of this intuition 
