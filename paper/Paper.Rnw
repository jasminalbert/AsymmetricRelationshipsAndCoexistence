...
An additional reason to quantify the importance of ATAs for species coexistence is that there is reason to believe climate change may
...
result in different competitive outcomes. Although we focus here on temporal coexistence
mechanisms, ATAs between environmental variables measured in different places may also be altered 
by climate change, if more intensive climatic events are also more spatially extensive, potentially 
influencing spatial coexistence mechanisms.
...
alter ATAs between environmental variables which are relevant for the coexistence (or not)
of species, motivating our efforts, here, to perform a detailed study of how ATAs can influence competition.
