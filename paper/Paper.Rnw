...
To further explore the parameter space, we generated two dimensional surface plots which reveal the subsets of parameter space where coexistence is possible with ranging degrees of ATA contributions and where ATA rescue occurs. We evaluated coexistence under two varying parameters and indicated $\Delta_i^{[EC]}/\text{IGR}$, a ratio of ATA contribution to total IGR, with a color bar and contour lines. Positive values of $\Delta_i^{[EC]}/\text{IGR}$ indicate coexistence and negative values indicate failure of coexistence. Greater magnitudes of $\Delta_i^{[EC]}/IGR$ and higher color intensity indicate greater contribution of ATAs to the IGR and positive cases where $\Delta_i^{[EC]}>IGR$ indicate ATA rescue. 
