...
%DAN: Jasmin will be adding that panel.
...
Panel (e) show the distribution $(E_i^\shp,C_{i \bs i}^\shp)$, defined in Theory
following \citep{Ellner_2016}, for comparison.
%DAN: jasmin is adding this new panel
