...
Impacts on competition and coexistence of climate change have been more commonly researched via studying changes in the mean of environmental variables. 
...
%...and variance...
Although, the body of literature on the impact of increased environmental variability has expanded, event-based studies accounted for only one-fifth of experimental climate change research as of 2006 \citep{Jentsch_2007}, the most commonly manipulated extremes being temperature and rainfall. Extreme drought and heat waves have shown to impact competitive output, rearranging species composition and dominance of grass-forb communities \citep{White_2000, White_2001, Hoover_2014}. However, complete exclusion of dominant species due to extreme events is uncommon \citep{Lloret_2012}. \cite{Fay_2003} experimentally manipulated rainfall for more frequent and intense precipitation while keeping constant the total volume of rain over Kansas tallgrass prairie and found that while some species had reduced fitness, overall community structure remained the same. For invasive species, increased climate and resource variability allowed for greater success of invasibility in terms of density and competitive equilibrium \citep{Parepa_2013}. 
%...and extreme events (though this blends together with changes in variance)
Although, increased variability of environmental fluctuations is a newer consideration for studying environmental changes, environmental variability has been analytically shown to be important for classical coexistence \citep{Chesson_1981, Warner_1985}. Moreover, by using MCT, increased variability has been shown to promote coexistence in plants communities, via the storage effect \citep{Adler_2006,  Angert_2009}. This present study has applications to extreme events and climate change as we consider relationships in their extremes, potentially caused by extreme events, and their implications for competition and coexistence. 
...
We simulated two different communities up to \Sexpr{M} time steps to hopefully make it clear to the that ATA makes a difference for competition and coexistence between species (see Figure \ref{fig:pedagog} for more details). The only distinction between the two simulations is that one depends on asymmetrically tail associated temporal dynamics and one does not. Markedly, the simulation with ATA has longer periods of one-species dominance than the simulation without, implying less recoverability when rare and thus less coexistence \citep{Chesson_2000} when environmentally dependent variables are asymmetrically tail associated.     
