...
temperature parameters revealed that its IGR is always positive and the ATA contribution is 
not meaningful (see SI section). %Mean EC shows a rescue effect against variance in E
