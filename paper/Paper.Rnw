...
IGR, with a color bar and contour lines. Greater magnitudes of $\Delta_i^{[EC]}/IGR$ and 
higher color intensity indicate greater contribution of ATAs to the IGR and positive cases 
where $\Delta_i^{[EC]}>IGR$ indicate ATA rescue. 
