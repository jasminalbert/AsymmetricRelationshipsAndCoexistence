...
in competition'' and ``storage effect'' \citep{Chesson_1994} which will be familiar to many readers. MCT has been
...
Though MCT's original analytical form presented mathematical challenges for applications to and tests of new systems, recent extensions expand testability and accessibility \citep{Ellner_2016,Ellner_2019}.
...
why ATAs may influence one mechanism of coexistence in particular: the storage effect. We review, conceptually, 
what the storage effect is \citep{Chesson_1994,Chesson_2012,Ellner_2016,Barabas_2018}, and explain why ATAs may be relevant to them.
