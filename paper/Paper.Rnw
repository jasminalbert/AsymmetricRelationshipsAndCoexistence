...
%***DAN: Jasmin, I just want to point out the below paragraph was quite well structured as it was 
%before I edited it. I only made changes on the sentence level. Nice job! Go aead and delete this 
%comment once you read it.
