...
applied to several systems, including annual \citep{Angert_2009, Hallett_2019} and perennial plants \citep{Adler_2010, Adler_2006}, 
tropical trees \citep{Usinowicz_2012}, plankton \citep{Narawani_2013, Descamps_2005, Caceres_1997}, and corals \citep{Alvarez-Noriega_2020}. 
...
considered in ecology (but see \citealp{Anderson_2019, deValpine_2014, Popovic_2019}), 
...
heat waves, floods, hurricanes and fires \citep{Jentsch_2007, Meehl_2004, Ummenhofer_2017, Lyon2019, Keelings2020}.  
...
For those familiar with the language of copula statistics (see, e.g., \citealp{Ghosh_2020_AER} and \citealp{Genest_2007}), 
...
Implementing new methods of MCT \citep{Ellner_2019, Ellner_2016}, we provided a further tertiary 
...
we used simple/extreme ATA
simple model and simple lab system
future work needed to assess the extent of how much ATA are important for complex field systems
what systems might be good? suggest systems and their important E vars.

Our investigation is a simple one; 
the ATA present is a perfect correlation is exactly one half of the relationship, 
but varying degrees of ATA may produce a similar result as well. 

We used the most extreme version of asymmetric noise, i.e., perfect correlation changing to very low correlation at exactly the half point of the distribution, and a simple lottery model.  
...
both halves of the distributions \citep{Ghosh_2020_AER,Nelsen2006}. The variables $(b_1,b_2)$ described in
