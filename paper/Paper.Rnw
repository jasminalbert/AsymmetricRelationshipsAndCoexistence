...
\noindent \textbf{Number of references:} 39; \textbf{Number of figures:} 5; \textbf{Number of tables:} 1; \textbf{Number of text boxes:} 0\\
...
does not depend on $i$. These choices for fulfill the assumption of Theory 
