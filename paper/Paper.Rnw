...
(d) has a partial Spearman correlation of  \Sexpr{round(plankStats$d$diff,3)}, indicating left-tail association
 and (e) has a partial Spearman correlation of  \Sexpr{round(plankStats$e$diff,3)}, indicating right-tail association \cite{Ghosh_2020_AER}.
