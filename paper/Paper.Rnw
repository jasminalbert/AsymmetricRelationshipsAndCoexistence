...
(e.g., various forms of regression), but correlations are extremely common, and other common
...
and, as a result, some species would be extirpated. Numerous studies also take an ``event-focussed'' 
...
and a means of understanding its theoretical and importance and its importance for real ecosystems.
